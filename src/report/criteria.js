...
const CRITERIA = [
  ...
  {
    cat: 'menu-label',
    check: 'ลิงก์ในส่วนหัว/เมนู/ส่วนท้าย (chrome) ชี้ปลายทางเดียวกัน แต่ข้อความลิงก์ต่างจากต้นฉบับไหม',
    method: 'จับคู่ลิงก์ chrome ข้ามฝั่งด้วย URL ปลายทางที่คาดหวัง แล้วเทียบข้อความลิงก์ (normalize แล้ว)',
    threshold: 'ข้อความลิงก์ต่างกัน (ไม่ใช่กรณีอังกฤษ/ไทย ซึ่งเข้าเกณฑ์ text-language แทน) = ปัญหา',
    sev: 'ปานกลาง',
  },
  {
    cat: 'image-ratio',
  ...
  {
    cat: 'hero',
    check: 'แบนเนอร์หลัก (hero, โมดูลแรกในเนื้อหาหลักที่มีรูป) รูปหรือหัวข้อเปลี่ยนไปไหม',
    method: 'ตรวจเฉพาะเมื่อต้นฉบับมีโมดูลแรกในเนื้อหาหลักที่มีรูปชัดเจน (ไม่งั้นข้ามเพื่อลด false positive); เทียบชื่อไฟล์รูปและข้อความหัวข้อ (normalize แล้ว) กับหน้าที่ย้าย',
    threshold: 'รูปแบนเนอร์หายหรือไม่ตรงกับต้นฉบับ = ปัญหา; หัวข้อแบนเนอร์ต่างจากต้นฉบับ = ปัญหา',
    sev: 'ปานกลาง',
  },
  {
    cat: 'layout',
